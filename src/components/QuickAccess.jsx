      ...
      <div className="grid grid-cols-3 md:flex md:flex-wrap gap-3">
        {quickAccessLinks.map((item, i) => (
          <a
            ...
            className="animate-fade-up group flex flex-col items-center justify-center gap-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-5 hover:border-navy dark:hover:border-blue-400 hover:bg-navy/5 dark:hover:bg-blue-900/20 hover:shadow-md transition-all duration-200 text-center min-w-[100px] md:flex-1"
          >
